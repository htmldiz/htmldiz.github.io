...
function readyjQueryinit(){
	...
	jQuery(function($) {
		...
		function render_popup(form){
			...
			$outhtml += '<div class="modal-box-top">Unpaid products in your cart are in high demand. We can"t guarantee their avaiability if you leave the site.</div>';
			...
			$outhtml += '</div>';
			$outhtml += '</div>';
			$outhtml += '<style>.modal-box-bottom-link{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;padding:10px}.modal-box-bottom-link a{margin:16px auto;border-radius:4px;background-color:#5bbfb9;font-size:12px;font-weight:700;letter-spacing:-0.17px;text-transform:uppercase;color:#ffffff;padding:10px}.modal-box-bottom{color:#e7624b;font-size:14px;font-weight:900;letter-spacing:-0.43px;border:1px solid #e7624b;background-color:#ffffff;max-width:90%;width:90%;margin-left:auto;margin-right:auto;padding:10px 24px;text-align:center}.modal-box-top{width:100%;color:#ffffff;font-family:Lato;font-size:12px;font-weight:700;letter-spacing:-0.37px;line-height:18px;padding:11px 12px;background-color:#e7624b;text-align:center}.fixed-box-modal{bottom:0;position:fixed;top:0;left:0;right:0;background:rgba(0,0,0,0.5);z-index:99999999999;display:none;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;overflow:auto}.fixed-box-modal.show{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex}td.cart__update-wrapper.cart-flex-item.text-right{position:absolute;bottom:9px;left:85px;padding-left:0px;padding-right:0;padding-bottom:0;width:42px}.fixed-box-modal-content .cart__qty{padding:0}.fixed-box-modal-content .cart__meta.small--text-left.cart-flex-item{-webkit-box-flex:0;-webkit-flex:0 0 auto;-ms-flex:0 0 auto;flex:0 0 auto;max-width:auto}.fixed-box-modal-content .cart__qty-input{height:28px;max-width:100%;padding:0;text-align:center}.fixed-box-modal-content tr.cart__row.border-bottom.cart-flex{position:relative;-webkit-box-align:start;-webkit-align-items:flex-start;-ms-flex-align:start;align-items:flex-start;display:-webkit-flex;display:-ms-flexbox;display:flex;width:100%;-webkit-flex-wrap:wrap;-moz-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap}.fixed-box-modal-content td.text-right.small--hide{display:block!important;-ms-flex-order:3;order:3;border:none;-webkit-align-self:center;-ms-flex-item-align:center;-ms-grid-row-align:center;align-self:center;-webkit-box-flex:0;-webkit-flex:0 0 100px;-ms-flex:0 0 100px;flex:0 0 100px;max-width:100px}.fixed-box-modal-content{min-height:80vh;width:80%;margin-left:auto;margin-right:auto;background:#ebeff2;margin-bottom:50px;margin-top:50px}.fixed-box-modal-content .border-bottom{border:none}.fixed-box-modal-content .cart-flex-item{-ms-flex-order:4;order:4;border:none}.fixed-box-modal-content .cart__meta{-ms-flex-order:2;order:2;font-size:12px;font-weight:400;letter-spacing:-0.4px;line-height:12px;color:#4a4d53;padding-left:0px;padding-bottom:0}.fixed-box-modal-content .cart__update-wrapper .spinner-new{max-width:100%}.fixed-box-modal-content .cart__image-wrapper{-ms-flex-order:1;order:1}.fixed-box-modal-content .cart__image-wrapper a{padding:0px}@media(min-width:750px){.fixed-box-modal-content .cart__meta{width:300px}.fixed-box-modal-content td.text-right.small--hide{max-width:calc(100% - 430px);flex:0 0 100%}td.cart__update-wrapper.cart-flex-item.text-right{left:130px}}@media(max-width:749px){.fixed-box-modal-content .cart__meta.small--text-left.cart-flex-item{max-width:calc(100% - 200px);flex:0 0 100%}.fixed-box-modal-content td.text-right.small--hide{font-size:12px}}@media(max-width:379px){.fixed-box-modal-content .cart__meta.small--text-left.cart-flex-item{max-width:90px;padding-right:5px}.fixed-box-modal-content td.text-right.small--hide{flex:0 0 80px;max-width:80px;padding:10px 8px}}</style>';
			$('body').append($outhtml);
