...
function readyjQueryinit(){
  ...
  $('body').append('<style>a.link-to-safe{position:relative;display: inline-block;float: right;width: 445px;margin-top: -5px;margin-right:60px;}.x-ss-page__line:after{left: -30px;right: -30px;}.x-ss-page{padding-right: 0px;padding-left: 0px; padding-bottom:0;}.for_cart_popup .b-cart__button.btn-trg{display: block;-webkit-box-sizing: border-box;box-sizing: border-box;margin: auto;padding: 11px;width: 100%;border: 0;border-radius: 3px;background-color: #51499d;color: #fff;text-align: center;font-weight: 700;font-size: 14px;cursor: pointer;-webkit-appearance: none;max-width: 400px;}.for_cart_popup .x-gradient-block {background: none;}.coverCloseIcon{cursor:pointer; position: absolute;top: 10px;right: 10px;width: 40px;height: 40px;z-index: 9;}.wrap-back-btn{margin-top: 60px;}.wrap-back-btn{background: #f6f8fd;margin-top: 60px;padding: 10px;position: sticky;bottom: 0;left: 0;right: 0;}</style>');
